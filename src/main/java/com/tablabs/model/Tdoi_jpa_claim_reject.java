...
public class Tdoi_jpa_claim_reject {
	...
	public Tdoi_jpa_claim_reject() {
		super();
	}

	public Tdoi_jpa_claim_reject(long claim_reject_id, long claim_recomm_id, long jpa_claim_id, int reject_reason_srno,
