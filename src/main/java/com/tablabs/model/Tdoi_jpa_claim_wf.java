...
public class Tdoi_jpa_claim_wf {
	private long jpa_claim_wf_id;
	private long trn_id;
	...
	public Tdoi_jpa_claim_wf() {
		super();
	}

	public Tdoi_jpa_claim_wf(long jpa_claim_wf_id, long trn_id, long actionconfig_id, long wf_action_id,
			...
			short active_status) {
		super();
		this.jpa_claim_wf_id = jpa_claim_wf_id;
		this.trn_id = trn_id;
	...
	public long getJpa_claim_wf_id() {
		return jpa_claim_wf_id;
	}

	public void setJpa_claim_wf_id(long jpa_claim_wf_id) {
		this.jpa_claim_wf_id = jpa_claim_wf_id;
	}
