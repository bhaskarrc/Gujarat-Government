...
public class Tdoi_hba_claim_wf {
	private long hba_claim_wf_id;
	private long trn_id;
	...
	public Tdoi_hba_claim_wf() {
		super();
	}

	public Tdoi_hba_claim_wf(long hba_claim_wf_id, long trn_id, long actionconfig_id, long wf_action_id,
			...
			short active_status) {
		super();
		this.hba_claim_wf_id = hba_claim_wf_id;
		this.trn_id = trn_id;
	...
	public long getHba_claim_wf_id() {
		return hba_claim_wf_id;
	}

	public void setHba_claim_wf_id(long hba_claim_wf_id) {
		this.hba_claim_wf_id = hba_claim_wf_id;
	}
